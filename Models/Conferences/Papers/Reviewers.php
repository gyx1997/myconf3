<?php
    ...
    namespace myConf\Models\Conferences\Papers;


    /**
     * Class Reviewer
     *
     * @package myConf\Models\Conferences\Paper
     */
    class Reviewers extends \myConf\BaseModel
    {
        ...
        /**
         * Get all reviewers in specified paper.
         * @param int $paper_id
         * @param int $paper_version
         *
         * @return array
         */
        public function getAll(int $paper_id, int $paper_version) : array {
            return $this->tables()
                ->PaperReview
                ->fetchAll(
                    array(
        ...
        array {
            ...
            //\myConf\Utils\Debugger::print_and_stop($results, __FILE__, __LINE__);
            return $results;
        }
